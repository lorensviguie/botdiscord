...
def format_masteries(masteries):
    result = "```\n{:<20} {:<25} {:<10} {:<20}\n".format("Champion", "Points de maîtrise", "Niveau", "Dernière fois joué")
    result += "="*90 + "\n"
    for mastery in masteries:
        ...
        result += "{:<20} {:<25} {:<10} {:<20}\n".format(champion_name, champion_points, champion_level, last_play_time_readable)
    result += "```"
    return result
